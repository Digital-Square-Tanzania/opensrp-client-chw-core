...
import org.smartregister.chw.core.presenter.CoreMotherMentorProfilePresenter;
...
/**
 * Core CHW wrapper for the Mother Mentor profile.
 */
public abstract class CoreMotherMentorProfileActivity extends BaseMotherMentorProfileActivity {
    ...
    public static void startProfileActivity(android.app.Activity activity, String baseEntityId) {
        android.content.Intent intent = new android.content.Intent(activity, CoreMotherMentorProfileActivity.class);
    ...
    protected void initializePresenter() {
        ...
        profilePresenter = new CoreMotherMentorProfilePresenter(this, new BaseMotherMentorProfileInteractor(), memberObject);
