...
public class ChwTbLeprosyRegisterProvider extends TbLeprosyRegisterProvider {


    public ChwTbLeprosyRegisterProvider(Context context, View.OnClickListener paginationClickListener,
