...
import org.smartregister.chw.core.model.CoreAypRegisterFragmentModel;
...
public class CoreAypRegisterFragment extends BaseAypRegisterFragment {
    private View view;
    ...
    protected void initializePresenter() {
        ...
        presenter = new BaseAypRegisterFragmentPresenter(this, new CoreAypRegisterFragmentModel(), null);
    }
    ...
    protected void openProfile(String baseEntityId) {
        org.smartregister.chw.core.activity.CoreAypProfileActivity.startProfileActivity(getActivity(), baseEntityId);
    }
}
