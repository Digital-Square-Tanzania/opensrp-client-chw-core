...
public class CoreVmmcRegisterFragmentModel extends BaseVmmcRegisterFragmentModel {
    ...
    protected String[] mainColumns(String tableName) {
        ...
        columnList.add(tableName + "." + org.smartregister.chw.vmmc.util.DBConstants.KEY.VMMC_TEST_DATE);
        ...
        columnList.add(CoreConstants.TABLE_NAME.PNC_MEMBER + "." + ChwDBConstants.IS_CLOSED + " as " + org.smartregister.chw.vmmc.util.DBConstants.KEY.IS_PNC_CLOSED);
        columnList.add(CoreConstants.TABLE_NAME.ANC_MEMBER + "." + ChwDBConstants.IS_CLOSED + " as " + org.smartregister.chw.vmmc.util.DBConstants.KEY.IS_ANC_CLOSED);
